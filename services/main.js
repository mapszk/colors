...
export const getColorData = async (color) => {
    const result = await model.generateContent(`
        ...
        The response must be just a json with the following structure:
        [
            {
                name: 'generated name', // generated one word name for the asked color
                scale: ['first color hex code', ..., 'last color hex code'] //  generated color scale for the asked color in order
            },
